...
hostnamectl set-hostname gdlcampusprograms
hostname

nano /etc/hosts
# add ip and hostname
159.89.146.106 gdlcampusprograms
...
##Computer
scp -r Desktop/automation_sharks manuiglesias@128.199.15.37:~/
...
server {
    listen 80;
    server_name 128.199.15.37;

    location /static {
        alias /home/manuiglesias/automation_sharks/auto_shark/static;
    }
...
[program:auto_shark]
directory=/home/manuiglesias/automation_sharks
command=/home/manuiglesias/automation_sharks/venv/bin/gunicorn -w 3 run:app
user=manuiglesias
autostart=true
autorestart=true
stopasgroup=true
killasgroup=true
stderr_logfile=/var/log/auto_shark/auto_shark.err.log
stdout_logfile=/var/log/auto_shark/auto_shark.out.log
