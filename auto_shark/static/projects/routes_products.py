...
def new_product():
    ...
    return render_template('product/new_final_evaluation_form.html', title='New Task',
...
def update_product(productid):
    ...
    return render_template('product/update_programs.html', legend="Update Product", form=form,
...
def all_product():
        ...
        return render_template('product/all_programs.html', products=products)
...
def product(productid):
        ...
        return render_template('product/program_details.html', product=product, form=form)
...
def table_products():
    ...
    return render_template('product/final_overview.html',
